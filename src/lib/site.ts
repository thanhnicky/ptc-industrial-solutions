...
export const ELECTRICAL_PRODUCTS = [
  {
    ...
    specs: [
      ["Dòng định mức (In)", "1600A – 6300A"],
      ["Dòng ngắn mạch (Icw)", "25 – 100 kA"],
      ["ACB chính", "1600A – 6300A (Schneider/ABB/LS)"],
      ["MCCB phụ", "250A – 1600A"],
      ["Số lộ ra", "4 – 24 lộ"],
      ["Thanh cái đồng", "Tiết diện tính theo Icw"],
      ["Form tủ", "Form 1, 2b, 3b, 4b"],
      ["Cấp IP", "IP31 – IP54"],
    ],
  },
  {
    ...
    specs: [
      ["Dòng định mức (In)", "400A – 2500A"],
      ["Dòng ngắn mạch (Icw)", "25 – 65 kA"],
      ["ACB/MCCB chính", "400A – 2500A"],
      ["MCCB phụ", "100A – 630A"],
      ["Số lộ ra", "6 – 18 lộ"],
      ["Form tủ", "Form 1, 2b, 3b"],
      ["Cấp IP", "IP31 – IP54"],
    ],
  },
  {
    ...
    specs: [
      ["Dòng định mức (In)", "63A – 630A"],
      ["Dòng ngắn mạch (Icw)", "10 – 35 kA"],
      ["MCCB chính", "63A – 630A"],
      ["MCCB phụ", "16A – 250A"],
      ["Số lộ ra", "4 – 24 lộ"],
      ["Form tủ", "Form 1, 2b"],
  ...
  },
  {
    ...
    specs: [
      ["Dòng điều khiển", "Theo công suất motor (0.75 – 500 kW)"],
      ["Khởi động", "DOL, Star-Delta, Soft Starter, VSD"],
      ["Contactor", "Theo motor kW (ABB/Schneider/LS)"],
      ["Relay nhiệt", "Bảo vệ quá tải + mất pha"],
      ["Biến tần VSD", "0.75 – 500 kW (ABB/Schneider/Yaskawa)"],
      ["Form tủ", "Form 2b, 3b, 4b (ngăn kéo/cố định)"],
      ["Tản nhiệt", "Quạt tản nhiệt + lọc bụi (nếu VSD)"],
      ["Cấp IP", "IP42 – IP55"],
    ],
  },
  {
    ...
    specs: [
      ["Công suất motor", "0.75 – 500 kW+"],
      ["Hãng biến tần", "ABB ACS580, Schneider ATV630, Yaskawa GA700"],
      ["Điện áp vào", "380V/400V 3 pha 50Hz"],
      ["Điện áp ra", "0 – 380V 3 pha (vô cấp)"],
      ["Tần số ra", "0 – 400 Hz"],
      ["Bảo vệ", "Quá tải, mất pha, quá áp, thấp áp, ngắn mạch"],
      ["Tản nhiệt", "Quạt tản nhiệt + cuộn kháng lọc hài (nếu cần)"],
      ["Cấp IP", "IP42 – IP54"],
    ],
  },
  {
    ...
    specs: [
      ["Số máy phát ghép", "2 – 8 máy phát"],
      ["Công suất máy phát", "100 – 2500 kVA mỗi máy"],
      ["Relay đồng bộ", "DeepSea DSE8612 / ComAp / Deif"],
      ["ACB hòa lưới", "1600A – 6300A"],
      ["Chia tải", "Tự động theo tỷ lệ công suất"],
      ["Bảo vệ", "27/59/81 + anti-islanding + reverse power"],
      ["Form tủ", "Form 2b, 3b"],
      ["Cấp IP", "IP31 – IP42"],
    ],
  },
  {
    ...
    specs: [
      ["Cấp IP", "IP55 / IP65"],
      ["Vỏ tủ", "Inox 304 / Tôn sơn tĩnh điện ngoài trời"],
      ["Cấu trúc", "2 lớp cánh, mái dốc thoát nước"],
      ["Gioăng", "EPDM đúc liền"],
      ["Điện trở sấy", "Chống đọng sương tự động"],
      ["Dòng định mức", "Tùy biến theo tải"],
      ["Form tủ", "Form 1, 2b"],
      ["Tiêu chuẩn IP", "IEC 60529"],
    ],
  },
  {
    slug: "tu-dien-solar",
    ...
    specs: [
      ["Tủ DC combiner", "IP65, 1000V/1500V DC"],
      ["SPD DC", "Type 2 chống sét lan truyền"],
      ["Fuse DC", "Per string, 15A – 30A"],
      ["Tủ AC phân phối", "IP54, MCCB + đo lường"],
      ["Tủ hòa lưới", "ACB + relay 27/59/81 + anti-islanding"],
      ["Điện áp DC", "1000V hoặc 1500V"],
      ["Điện áp AC", "380V/400V 3 pha"],
      ["Cấp IP", "IP65 (DC) / IP54 (AC)"],
    ],
  },
  {
    ...
    specs: [
      ["Dòng định mức", "32A – 400A"],
      ["ELCB/RCCB", "30mA – 300mA chống dòng rò"],
      ["Số ổ cắm", "4 – 12 ổ (có nắp đậy)"],
      ["Vỏ tủ", "Tôn sơn tĩnh điện / Composite"],
      ["Chân đế", "Đế di động có bánh xe"],
      ["Cấp IP", "IP44 – IP55"],
      ["Form tủ", "Form 1"],
      ["Tiêu chuẩn", "TCVN 7994, TCVN 5863"],
    ],
  },
  {
    slug: "tram-kios",
    ...
    specs: [
      ["Công suất MBA", "160 – 2500 kVA"],
      ["Điện áp trung thế", "22kV / 35kV"],
      ["Điện áp hạ thế", "0.4kV"],
      ["Ngăn RMU", "SF6 load break switch + fuse"],
      ["Ngăn MBA", "Dầu / Khô (cast resin)"],
      ["Ngăn hạ thế", "ACB + MCCB phân phối"],
      ["Cấp IP", "IP43 – IP54"],
      ["Vỏ trạm", "Tôn sơn tĩnh điện / Inox"],
    ],
  },
  {
    slug: "tu-dieu-khien",
    ...
    specs: [
      ["PLC", "Siemens S7-1200/1500, Mitsubishi FX5U"],
      ["HMI", "Màn hình 7\" – 15\" (Siemens/Proface)"],
      ["Module I/O", "Digital + Analog, theo yêu cầu"],
      ["Relay trung gian", "Omron / Schneider"],
      ["Nguồn cấp", "24VDC / 220VAC"],
      ["Giao tiếp", "Modbus RTU/TCP, Profinet, Ethernet"],
      ["Form tủ", "Form 1, 2b"],
      ["Cấp IP", "IP42 – IP54"],
    ],
  },
  {
    ...
    specs: [
      ...
      ["Số pha", "1 pha / 3 pha"],
      ["Dòng đo", "10A – 100A"],
      ["Chống UV", "Có (không bị lão hóa ngoài trời)"],
      ["Cách điện", "Hoàn toàn (vỏ composite)"],
      ["Chống va đập", "IK10"],
      ["Cấp IP", "IP65"],
      ["Kích thước", "Theo chuẩn EVN"],
    ],
  },
];
...
export const CABLE_TRAY_PRODUCTS = [
  {
    ...
    specs: [
      ["Vật liệu", "Tôn thép cán nguội"],
      ["Mạ", "Sơn tĩnh điện / Mạ kẽm nhúng nóng"],
      ["Kích thước", "100×50 – 600×100 mm"],
      ["Bề dày", "0.8 – 1.5 mm"],
      ["Tiêu chuẩn", "IEC 61537"],
      ["Tải trọng", "Tính theo nhịp đỡ 1.5 – 3m"],
    ],
  },
  {
    slug: "khay-cap",
    ...
    specs: [
      ...
      ["Kích thước", "100×50 – 600×100 mm"],
      ["Bề dày", "1.0 – 2.0 mm"],
      ["Loại", "Có lỗ / Không lỗ (perforated)"],
      ["Tiêu chuẩn", "IEC 61537"],
    ],
  },
  {
    ...
    specs: [
      ["Vật liệu", "Tôn thép cán nguội"],
      ["Mạ", "Sơn tĩnh điện / Mạ kẽm nhúng nóng"],
      ["Kích thước", "100×100 – 600×150 mm"],
      ["Bề dày", "1.2 – 2.5 mm"],
      ["Cấu trúc", "2 thanh biên + các ngang"],
      ["Tiêu chuẩn", "IEC 61537"],
    ],
  },
  {
    ...
    specs: [
      ["Vật liệu", "Tôn thép chống trượt"],
      ["Mạ", "Sơn tĩnh điện / Mạ kẽm nhúng nóng"],
      ["Kích thước", "Theo bản vẽ thiết kế"],
      ["Tải trọng", "150 – 300 kg/m²"],
      ["Tiêu chuẩn", "TCVN 9362"],
    ],
  },
  {
    ...
    specs: [
      ["Loại", "Cút cong, T-branch, cút giảm, nắp đậy"],
      ["Vật liệu", "Theo thang/khay chính"],
      ["Mạ", "Đồng bộ với thang/khay"],
      ["Bulong", "M8/M10 mạ kẽm"],
      ["Tiêu chuẩn", "IEC 61537"],
    ],
  },
  {
    ...
    specs: [
      ["Vật liệu", "Tôn thép cán nguội"],
      ["Mạ", "Mạ kẽm nhúng nóng 65-85 µm"],
      ["Kích thước", "100×50 – 600×100 mm"],
      ["Bề dày", "0.8 – 1.5 mm"],
      ["Độ bền ngoài trời", "20 – 30 năm"],
      ["Tiêu chuẩn", "IEC 61537, ISO 1461"],
    ],
  },
  {
...
export const KNOWLEDGE_ARTICLES = [
  ...
  {
    slug: "boc-tach-boq-thang-mang-cap-khong-thieu-phu-kien",
    title: "Bóc tách BOQ thang máng cáp không thiếu phụ kiện: Checklist 12 hạng mục",
    category: "Thang máng cáp & BOQ",
    readTime: "7 phút",
    author: "Mr X.Bach PTC",
    datePublished: "2026-09-12",
    dateModified: "2026-09-12",
    quickAnswer: "Bóc tách BOQ thang máng cáp cần kiểm tra 12 hạng mục: (1) thang/khay/máng chính, (2) co ngang 90°, (3) co lên/co xuống, (4) tê 3 nhánh, (5) chữ thập 4 nhánh, (6) giảm đều/giảm lệch, (7) nắp đậy, (8) ty treo + quang treo, (9) bulong nối, (10) bích bắt tường, (11) nẹp kết thúc, (12) phụ kiện đặc biệt (đèn, cảm biến). Thiếu 1 hạng mục → phát sinh tại công trường.",
    summary: [
    ...
    body: [
      {
        heading: "Vì sao bóc tách BOQ thang máng cáp hay thiếu phụ kiện",
        paragraphs: [
          "Thang máng cáp không chỉ là thang/khay/máng chính — phụ kiện chiếm 30-40% số lượng và 20-30% giá trị tuyến. Tuy nhiên, nhiều nhà thầu M&E chỉ bóc tách thang chính, để quên phụ kiện. Khi ra công trường mới phát hiện thiếu co, thiếu tê, thiếu ty treo → phải đặt mua gấp → chặn tiến độ + tăng chi phí.",
          "Nguyên nhân chính: phụ kiện thang máng cáp không có trong BOQ của tư vấn thiết kế, hoặc có nhưng liệt kê chung chung (\"phụ kiện theo yêu cầu\") mà không bóc tách chi tiết.",
        ],
      },
      {
        heading: "Checklist 12 hạng mục bóc tách BOQ thang máng cáp",
        table: {
          headers: ["#", "Hạng mục", "Ghi chú"],
          rows: [
            ["1", "Thang/khay/máng chính", "Chiều dài × chiều rộng × chiều cao × độ dày × bề mặt"],
            ["2", "Co ngang 90°", "Mỗi lần rẽ ngang tuyến cần 1 co"],
            ["3", "Co lên / co xuống", "Mỗi lần vượt ống/đà cần 1 cặp co lên + co xuống"],
            ["4", "Tê 3 nhánh (T-branch)", "Mỗi nhánh rẽ ra cần 1 tê"],
            ["5", "Chữ thập 4 nhánh", "Mỗi giao cắt 2 tuyến cần 1 chữ thập"],
            ["6", "Giảm đều / giảm lệch", "Mỗi lần đổi kích thước tuyến cần 1 giảm"],
            ["7", "Nắp đậy", "Theo chiều dài thang chính + phụ kiện (nếu yêu cầu)"],
            ["8", "Ty treo + quang treo", "Cứ 1.5-2m 1 bộ ty treo + quang"],
            ["9", "Bulong nối + đai ốc", "Mỗi mối nối thang cần 2-4 bulong"],
            ["10", "Bích bắt tường / sàn", "Mỗi đầu tuyến hoặc mỗi lần bám tường cần bích"],
            ["11", "Nẹp kết thúc", "Mỗi đầu tuyến cần 1 nẹp kết thúc"],
            ["12", "Phụ kiện đặc biệt", "Đèn dẫn hướng, cảm biến nhiệt, nắp chia ngăn..."],
          ],
        },
        callout: {
          type: "warning",
          title: "Hạng mục #8 (ty treo) là hạng mục bị quên nhiều nhất",
          text: "Nhiều BOQ ghi \"ty treo theo yêu cầu\" mà không tính số lượng. Ty treo cần cứ 1.5-2m 1 bộ. Tuyến 100m cần 50-67 bộ. Thiếu ty treo → thang võng → cáp bị kéo dão.",
        },
      },
      {
        heading: "3 lỗi bóc tách phổ biến",
        list: {
          ordered: true,
          items: [
            "<strong>Quên co lên/co xuống:</strong> Tuyến cáp phải vượt ống gió, đà thép, ống nước — mỗi lần vượt cần 1 cặp co lên + co xuống. BOQ hay ghi \"co theo thực tế\" → ra công trường thiếu.",
            "<strong>Thiếu ty treo:</strong> BOQ ghi \"ty treo theo yêu cầu\" mà không tính số lượng. Tuyến 100m cần 50-67 bộ ty treo + quang treo. Thiếu → thang võng → cáp dão.",
            "<strong>Sai số lượng nắp đậy:</strong> Nắp đậy tính theo chiều dài thang chính + chiều dài phụ kiện. Nhiều BOQ chỉ tính thang chính, quên nắp cho co/tê/giảm.",
          ],
        },
      },
      {
        heading: "Cách bóc tách BOQ thang máng cáp đúng",
        paragraphs: [
          "Quy trình bóc tách BOQ thang máng cáp tại PTC:",
        ],
        list: {
          ordered: true,
          items: [
            "<strong>Nhận bản vẽ tuyến cáp:</strong> Layout isometric hoặc 2D thể hiện tuyến thang/khay/máng, vị trí rẽ nhánh, vị trí vượt ống/đà.",
            "<strong>Bóc tách thang chính:</strong> Tính chiều dài từng loại (thang/khay/máng) theo kích thước + bề mặt.",
            "<strong>Bóc tách phụ kiện:</strong> Đếm số co, tê, chữ thập, giảm theo bản vẽ. Mỗi rẽ nhánh = 1 tê. Mỗi giao cắt = 1 chữ thập. Mỗi vượt = 1 cặp co lên/xuống.",
            "<strong>Tính ty treo:</strong> Cứ 1.5-2m 1 bộ ty treo + quang treo. Tuyến 100m = 50-67 bộ.",
            "<strong>Tính nắp đậy:</strong> Theo chiều dài thang chính + phụ kiện (nếu yêu cầu nắp).",
            "<strong>Tính bulong + bích:</strong> Mỗi mối nối thang 2-4 bulong. Mỗi đầu tuyến 1 bích.",
            "<strong>Phát hành BOQ chi tiết:</strong> Bảng Excel liệt kê từng hạng mục + số lượng + quy cách.",
          ],
        },
      },
      {
        heading: "So sánh BOQ thiếu vs BOQ đủ phụ kiện",
        table: {
          headers: ["Hạng mục", "BOQ thiếu (sai)", "BOQ đủ (đúng)"],
          rows: [
            ["Thang chính 300×100", "100m", "100m"],
            ["Co ngang 90°", "Theo thực tế", "8 cái"],
            ["Co lên/xuống", "Theo thực tế", "6 cặp"],
            ["Tê 3 nhánh", "Theo thực tế", "4 cái"],
            ["Ty treo + quang", "Theo yêu cầu", "55 bộ"],
            ["Nắp đậy", "Theo yêu cầu", "100m + 8 co + 6 cặp + 4 tê"],
            ["Bulong nối", "Theo yêu cầu", "120 bộ"],
          ],
        },
        callout: {
          type: "info",
          title: "BOQ \"theo thực tế\" = phát sinh công trường",
          text: "Khi BOQ ghi \"theo thực tế\" hoặc \"theo yêu cầu\", nhà thầu phải tự đếm tại công trường → dễ thiếu → đặt mua gấp → chặn tiến độ. BOQ chi tiết với số lượng cụ thể giúp đặt sản xuất 1 lần, giao đủ, lắp đủ.",
        },
      },
      {
        heading: "PTC bóc tách BOQ thang máng cáp miễn phí",
        paragraphs: [
          "PTC cung cấp dịch vụ bóc tách BOQ thang máng cáp miễn phí cho nhà thầu M&E và chủ đầu tư:",
        ],
        list: {
          ordered: false,
          items: [
